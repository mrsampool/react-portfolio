...
export function FeaturedThumb(props){
    ...
    return(
        <button
            className={`projThumb ${handleFocus()}`}
            onClick={handleClick}
        >
...
export function FeaturedProjects(props){
    ...
    return(
        <div className={'featProj'}>
            ...
            <h2 className={'text-center'}>FEATURED <br/>PROJECTS</h2>

            <div className={'row d-flex flex-column-md align-items-center justify-content-center'}>
...
export function ProjectSummary(props){
    ...
    function getTech(techData){
        const tech = techData.map( tech =>{
            return(
                <div className={'techItem d-flex flex-column justify-content-center align-items-center'}>
        ...
        return(
            <div className={'techList row'}>
                <div className={'col'}>
                    ...
                    <div className={'row'}>
                        <div className={'col d-flex flex-row justify-content-around flex-wrap'}>
                            {tech}
                        </div>
                    </div>
        ...
        <section className={'projSummary'}>
            ...
            <div className={'row no-gutters'}>
                ...
                <div className={'col-lg'}>
                    ...
                    <section className={'projScreens row d-flex flex-row justify-content-center'}>
